                                                ...
                                                <tbody class="kt-table-tbody text-dark">
                                                    ...
                                                    {{-- {{ dd($requisition) }} --}}
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ @$requisition->admin->full_name }}</td>
                                                            ...
                                                            <td class="text-center">{{ (is_null($requisition->status_update_at)) ? $requisition->status_update_date : null }}</td>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="card-toolbar text-end">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right"
                                                                        ...
                                                                        @if ($requisition->status == 'pending')
                                                                        <!-- Pending Status - Show Approve and Reject options -->
                                                                        <a href="{{ route('admin.material_requisitions.update_status', ['id' => $requisition->hashid, 'status' => 'approve']) }}"
                                                                        ...
                                                                        <a href="{{ route('admin.material_requisitions.update_status', ['id' => $requisition->hashid, 'status' => 'reject']) }}"
                                                                            class="dropdown-item click-edit update_status"
                                                                            id="click-edit2" 
                                                                            data-bs-toggle="tooltip"
                                                                            title="Reject this requisition"
                                                                            data-bs-placement="right"
                                                                            data-original-title="Reject">Reject</a>
                                                                    @elseif ($requisition->status == 'approve')
                                                                        <!-- Approve Status - Show Reject and Pending options -->
                                                                        <a href="{{ route('admin.material_requisitions.update_status', ['id' => $requisition->hashid, 'status' => 'pending']) }}"
                                                                            class="dropdown-item click-edit update_status"
                                                                            id="click-edit2" 
                                                                            data-bs-toggle="tooltip"
                                                                            title="Mark as Pending"
                                                                            data-bs-placement="right"
                                                                            data-original-title="Pending">Mark as Pending</a>
                                                                        <a href="{{ route('admin.material_requisitions.update_status', ['id' => $requisition->hashid, 'status' => 'reject']) }}"
                                                                            class="dropdown-item click-edit update_status"
                                                                            id="click-edit2" 
                                                                            data-bs-toggle="tooltip"
                                                                            ...
                                                                            data-bs-placement="right"
                                                                            data-original-title="Reject">Reject</a>
                                                                    @elseif ($requisition->status == 'reject')
                                                                        <!-- Reject Status - Show Approve and Pending options -->
                                                                        <a href="{{ route('admin.material_requisitions.update_status', ['id' => $requisition->hashid, 'status' => 'approve']) }}"
                                                                            class="dropdown-item click-edit update_status"
                                                                            id="click-edit2" 
                                                                            data-bs-toggle="tooltip"
