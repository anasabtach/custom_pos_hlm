                            ...
                            <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                                <div class="card-header align-items-center  border-bottom-dark px-0">
                                    <div class="card-title mb-0">
                                        <h3 class="card-label mb-0 font-weight-bold text-body">Suppliers
                                        </h3>
                                    </div>
                                                ...
                                                <tbody class="kt-table-tbody text-dark">
                                                    @foreach ($suppliers as $supplier)
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><p class="text-sm font-weight-bold mb-0">{{ $supplier->name }}</p></td>
                                                            <td class="text-center"><p class="text-sm font-weight-bold mb-0">{{ $supplier->email }}</p></td>
                                                            <td class="text-center"><p class="text-sm font-weight-bold mb-0">{{ $supplier->phone_no }}</p></td>
                                                            <td class="text-center"><p class="text-sm font-weight-bold mb-0">{{ $supplier->city }}</p></td>
                                                            <td class="text-center"><p class="text-sm font-weight-bold mb-0">{{ $supplier->address }}</p></td>
                                                            <td class="text-center"><p class="text-sm font-weight-bold mb-0">{{ $supplier->note }}</p></td>
