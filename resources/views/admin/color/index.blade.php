                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <fieldset class="form-group mb-3">
                                                <input type="text" placeholder="Enter color name"
                                                    ...
                                                    value="{{ isset($is_update) ? $edit_color->color : old('color') }}"
                                                    name="color" id="color">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="card-toolbar text-end">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right"
                                                                        ...
                                                                        @can('edit-brand')
                                                                            <a href="{{ route('admin.colors.edit', ['color_id' => $color->hashid]) }}"
                                                                        ...
                                                                        @can('delete-brand')
                                                                            <a class="dropdown-item"
                                                                                title="Delete"
                                                                                href="{{ route('admin.colors.delete', ['color_id' => $color->hashid]) }}">Delete</a>
                                                                        @endcan
                                                                    </div>
                                                                </div>
                                                            </td>
