                        ...
                        <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                            <div class="card-header align-items-center  border-bottom-dark px-0">
                                ...
                                <div class="icons d-flex">
                                    <a href="{{ route('admin.products.create') }}" class="btn ms-2 p-0" id="kt_notes_panel_toggle" data-bs-toggle="tooltip"
                                        ...
                                        <tbody class="kt-table-tbody text-dark">
                                            @foreach($products as $product)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <p class="text-sm font-weight-bold mb-0">{{ @$product->unit->name }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <p class="text-sm font-weight-bold mb-0">{{ $product->stock_alert }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="text-sm font-weight-bold mb-0">{{ getCustomDate($product->expiration) }}</p>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="card-toolbar text-end">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton01">
                                                                <a href="{{ route('admin.products.edit', ['product_id'=>$product->hashid]) }}" class="dropdown-item click-edit">Edit</a>
                                                                <a class="dropdown-item confirm-delete" href="{{ route('admin.products.delete', ['product_id'=>$product->hashid]) }}">Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
